...
namespace Filuet.Infrastructure.Abstractions.Communication
{
    public interface INotificationManager : IEventProducer
    {
        ...
        /// <param name="additionalInfo">Любая дополнительная информация</param>
        /// <param name="terminalId">Имя терминала отправителя</param>
        void AddMessageToSend(NotificationTypes type, string additionalInfo, string terminalId = null);
        /// <summary>
        /// Асинхронно добавить уведомление определённого типа в список на отправку
        /// </summary>
        /// <param name="type">Тип уведомления</param>
        /// <param name="additionalInfo">Информация от терминала со значениями в формате 'имя аргумента'='значение', разделенные ';'</param>
        /// <param name="terminalId">Имя терминала отправителя</param>
        Task AddMessageToSendAsync(NotificationTypes type, string additionalInfo, string terminalId = null);
        /// <summary>
